...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="sidebar border-r border-border bg-secondary text-primary">
        ...
        {!isCollapsed && (
          <div className="mt-8 px-4">
            ...
            <div className="space-y-2">
              ...
              <button className="w-full p-2 border border-border rounded-lg hover:bg-accent/10 hover:border-accent transition-colors text-white bg-secondary">
                <span className="text-sm">Join Practice Room</span>
              </button>
              {/* Add Start Learning for Free and Log In buttons below */}
              <button
                className="w-full btn bg-accent text-white font-bold rounded-lg py-2 hover:shadow-[0_0_15px_#A3FF6A,0_0_25px_#7ED321] hover:bg-accent transition-all"
              >
                <span className="font-medium">Start Learning for Free</span>
              </button>
              <button
      ...
      {/* Temporary: Direct access to Debate Room */}
      <div className="px-4 pb-4 mt-auto">
        <NavLink to="/debate-room">
          <button className="w-full bg-blue-600 text-white rounded-lg py-2 text-sm font-semibold hover:bg-blue-700 transition-all">
            Go to Debate Room
          </button>
        </NavLink>
      </div>
