...
const formats = [
  ...
  { id: "pf", name: "Public Forum", desc: "2v2 format focused on current events", icon: Users },
];
  ...
  const steps = [
    ...
    <div key="step6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            {speechTimes.map(t => (
              <Button key={t} variant={state.speechTime === t ? "default" : "outline"} onClick={() => setState(s => ({ ...s, speechTime: t }))}>{t} min</Button>
            ))}
          </div>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            {prepTimes.map(t => (
              <Button key={t} variant={state.prepTime === t ? "default" : "outline"} onClick={() => setState(s => ({ ...s, prepTime: t }))}>{t} min</Button>
            ))}
          </div>
        </div>
        <div className="flex flex-col gap-2">
    ...
    <div key="step7">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <Label>Translation Support</Label>
